...
export default function Navbar() {
    ...
    const fetchUploadedPicture = async () => {
        try {
            const response = await api.get(`/api/${userId}/get-profile-picture`, { responseType: 'arraybuffer' });
    ...
    return (
        <div className="navbar">
            ...
            <div className="navbar-right">
                <Avatar alt="Remy Sharp" src={uploadedPictureUrl} style={{ width: '60px', height: '60px' }}  />
